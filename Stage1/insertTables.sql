...
values (19.36, to_date('16-10-2020', 'dd-mm-yyyy'), 'Montreal 9100 Boulevard de l A', 383.38, 100, 891325545, 240883177, 371);

insert into ACTUAL_TRAINING (TRAINING_HOUR, TRAINING_DATE, TRAINING_LOCATION, TRAINING_COST, ACTUAL_TRAINING_CODE, PERSON_ID1, PERSON_ID2, TRAINING_CODE)
values (17.43, to_date('16-10-2020', 'dd-mm-yyyy'), 'Bangkok 990 Silom Road', 149.92, 101, 439643727, 482412253, 404);

insert into ACTUAL_TRAINING (TRAINING_HOUR, TRAINING_DATE, TRAINING_LOCATION, TRAINING_COST, ACTUAL_TRAINING_CODE, PERSON_ID1, PERSON_ID2, TRAINING_CODE)
values (13.98, to_date('31-10-2024', 'dd-mm-yyyy'), 'Rome Via dei Congressi 33', 456.23, 102, 256244114, 953151798, 108);

insert into ACTUAL_TRAINING (TRAINING_HOUR, TRAINING_DATE, TRAINING_LOCATION, TRAINING_COST, ACTUAL_TRAINING_CODE, PERSON_ID1, PERSON_ID2, TRAINING_CODE)
values (20.21, to_date('13-03-2024', 'dd-mm-yyyy'), 'Atlanta 3333 Peachtree Road NE', 282.43, 103, 207996683, 786226109, 410);

insert into ACTUAL_TRAINING (TRAINING_HOUR, TRAINING_DATE, TRAINING_LOCATION, TRAINING_COST, ACTUAL_TRAINING_CODE, PERSON_ID1, PERSON_ID2, TRAINING_CODE)
values (13.11, to_date('07-07-2023', 'dd-mm-yyyy'), 'London 8 Canada Square', 326.88, 104, 119798937, 861440050, 85);

insert into ACTUAL_TRAINING (TRAINING_HOUR, TRAINING_DATE, TRAINING_LOCATION, TRAINING_COST, ACTUAL_TRAINING_CODE, PERSON_ID1, PERSON_ID2, TRAINING_CODE)
values (8.18, to_date('29-05-2024', 'dd-mm-yyyy'), 'Houston 3 Greenway Plaza', 340.39, 105, 478380949, 558821746, 142);

insert into ACTUAL_TRAINING (TRAINING_HOUR, TRAINING_DATE, TRAINING_LOCATION, TRAINING_COST, ACTUAL_TRAINING_CODE, PERSON_ID1, PERSON_ID2, TRAINING_CODE)
values (18.67, to_date('14-08-2021', 'dd-mm-yyyy'), 'Mumbai G Block Bandra Kurla Co', 228.27, 106, 592163243, 339168131, 26);

insert into ACTUAL_TRAINING (TRAINING_HOUR, TRAINING_DATE, TRAINING_LOCATION, TRAINING_COST, ACTUAL_TRAINING_CODE, PERSON_ID1, PERSON_ID2, TRAINING_CODE)
values (7.88, to_date('28-02-2023', 'dd-mm-yyyy'), 'Austin 9800 Metric Blvd', 313.70, 107, 594211402, 357964464, 149);

insert into ACTUAL_TRAINING (TRAINING_HOUR, TRAINING_DATE, TRAINING_LOCATION, TRAINING_COST, ACTUAL_TRAINING_CODE, PERSON_ID1, PERSON_ID2, TRAINING_CODE)
values (19.23, to_date('03-03-2024', 'dd-mm-yyyy'), 'Phoenix 2400 Biltmore Fashion ', 381.76, 108, 608510484, 273396102, 486);

insert into ACTUAL_TRAINING (TRAINING_HOUR, TRAINING_DATE, TRAINING_LOCATION, TRAINING_COST, ACTUAL_TRAINING_CODE, PERSON_ID1, PERSON_ID2, TRAINING_CODE)
values (17.28, to_date('08-05-2020', 'dd-mm-yyyy'), 'Buenos Aires Juana Manso 1670 ', 140.12, 109, 439643727, 398601481, 114);
